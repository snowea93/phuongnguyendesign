...
$recipient = "phuongngdesign@gmail.com";// Change the recipient email adress to your adrees  
...
if (!$error){
		...
		if ($sending) {
				...
				echo "Your message has been successfully sent, thank you. Stay in touch!"; 
			} else {
